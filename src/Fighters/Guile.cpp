...
namespace Util {
    ...
    void Guile::LoadOffsetVelocity() {
        ...
        //Stand attack offset
        offset[FighterState::LP]={{1,-1},{53,-2},{53,-2}};
        offset[FighterState::MP]={{27,-27},{18,-17},{18,30},{16,6},{19,-18}};
        offset[FighterState::HP]={{-19,10},{-19,10},{19,9},{17,9},{78,-5},{73,-3}};
        offset[FighterState::LK]={{-3,6},{3,2},{91,1}};
        offset[FighterState::MK]={{-17,8},{-17,9},{-22,8},{23,10},{45,5},{45,5}};
        offset[FighterState::HK]={{-9,10},{-7,12},{49,12},{50,12},{96,13},{55,26}};
        //Crouch attack offset
        offset[FighterState::CrouchLP]={{1,-33},{49,-35},{49,-35}};
        offset[FighterState::CrouchMP]={{36,-46},{36,-46},{55,-48},{38,-48}};
        ...
        offset[FighterState::CrouchHK]={{37,-45},{101,-49},{152,-52},{124,-50},{65,-49},{42,-46},{-87,-58},{-51,-42},{24,-59},{-42,-42},{-37,-42}};
    ...
    void Guile::LoadAllBox() {
        ...
        boxes.hurtbox.head.offset[FighterState::Crouch]={{18,43}};
        ...
        boxes.hurtbox.head.offset[FighterState::CrouchDown]={{20,101},{22,44},{18,43}};
        ...
        boxes.hurtbox.head.offset[FighterState::CrouchUp]={{18,43},{22,44},{20,101}};
